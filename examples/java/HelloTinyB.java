...
//        System.out.print("}");
  ...
  public static void main(String[] args) throws InterruptedException, ExecutionException {
    ...
    BluetoothGattService configService = getService(sensor, "1c930002-d459-11e7-9296-b8e856369374");
    ...
    BluetoothGattCharacteristic calibrationCharacteristic = getCharacteristic(configService, "1c930023-d459-11e7-9296-b8e856369374");
...
//     init(tempValue, batValue);
    ...
    for (byte b : calibrationValue) {
       ...
       int temperature = ByteBuffer.wrap(calibrationValue).order(ByteOrder.LITTLE_ENDIAN).getInt();
//     double temperature =
